ALTER TABLE  `uctoo_field` ADD  `role_id` INT( 11 ) NOT NULL AFTER  `id`;
ALTER TABLE  `uctoo_member` ADD  `last_login_role` INT( 11 ) NOT NULL AFTER  `last_login_ip`;
ALTER TABLE  `uctoo_member` ADD  `show_role` INT( 11 ) NOT NULL COMMENT  '个人主页显示角色' AFTER  `last_login_role`;
